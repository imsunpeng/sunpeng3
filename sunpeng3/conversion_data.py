...
@click.command()
@click.option('-d', '--data', help='kits21 data path',
              type=click.Path(exists=True, dir_okay=True, resolve_path=True), default='kits21/data', show_default=True)
